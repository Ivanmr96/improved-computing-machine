            ...
            if (lastPage.FullName.Equals("Pinturillo.SalaEspera"))
            {
                if (e.Parameter != null)
                {
                    ...
                    //De momento lo he apañao en el servidor poniendo que si es null la partida no haga nada 
                        ...
                        //Ese apaño no sirve porque siguen llamando todos los clientes (y como es la primera vez, da igual lo del puedesFuncionar del
                        //viewModel, tienes que hacer que solo UN CLIENTE llame
