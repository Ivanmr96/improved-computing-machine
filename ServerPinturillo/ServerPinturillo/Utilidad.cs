...
namespace ServerPinturillo
{
    public class Utilidad
    {
        ...
        private static String[] listadoPalabras = {
            ...
            "Círculo","Ordenador","Pizarra","Darth Vader","Iron Man","Capitán América","Hulk", "Superman","Batman",
            "Thor","Spiderman","Thanos","Flash","Cebolla", "Tarjeta", "Pegatina", "Cristal", "Mopa", "Lápiz", "Saltamontes",
            "Hormiga", "Proyector", "Pimiento", "Autobus", "Coche", "Vaca", "Burro", "Virus", "Juego de mesa", "Mesa",
            "Cacatúa", "Luna", "Amor", "Corazón", "Melón", "Sandía", "Kiwi", "Foto", "Camiseta", "Pantalones", "Atenea", "Zeus",
            "Lavadora", "Lavavajillas", "Fregadero", "Sofá", "Padre", "Dios", "Madre", "Botella","Harry potter",
            "Tomate", "Columna", "Fila", "Nevera", "Taza", "Cuenco", "Arroz", "Lechuga", "Aire acondicionado", "Calentador", "Cuadro",
            "Televisión", "Portugal", "España", "Francia", "Silla", "Sevilla", "Física", "Matemáticas",
            ...
            "Pulsera", "Agenda", "Cable", "Hoja","Mes", "Tiempo", "Legendario", "Leyenda","Navidad", "Frente",
            ...
            "Ombligo", "Disquete", "Cronómetro", "Juego", "Termostato", "Sello", "Fiesta", "Lejos", "Cerca", "Barrera", "Hospital",
            "Rastro", "Rata", "Careta", "Carnaval", "Batidora", "Horno", "Microondas", "Instrumentos", "Saxofón", "Piano", "Química",
